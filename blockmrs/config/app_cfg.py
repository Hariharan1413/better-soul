...
from bettersoul import model, lib
from bettersoul.model.auth import User
...
base_config.package = bettersoul
...
base_config.model = bettersoul.model
base_config.DBSession = bettersoul.model.DBSession
