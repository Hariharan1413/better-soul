...
from bettersoul import model
from bettersoul.model import DBSession
from bettersoul.config.app_cfg import AdminConfig
from tgext.admin.controller import AdminController

from bettersoul.lib.base import BaseController
from bettersoul.controllers.error import ErrorController
from bettersoul.controllers.portal import UserPortalController
from bettersoul.controllers.symptom import SymptomController
...
class RootController(BaseController):
    ...
    def _before(self, *args, **kw):
        tmpl_context.project_name = "bettersoul"

    @expose('bettersoul.templates.index')
    def index(self):
    ...
    @expose('bettersoul.templates.login')
